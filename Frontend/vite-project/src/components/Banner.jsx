...
function Banner() {
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10 -mb-1 ${darkMode ? "bg-slate-900 text-white" : "bg-white text-gray-500"}`} >
